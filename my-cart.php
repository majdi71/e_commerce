				...
				<tr>
					...
					<td class="cart-image">
						<a class="entry-thumbnail" href="product-details.php">
						    <img src="admin/productimages/<?php echo $row['id'];?>/<?php echo $row['productImage1'];?>" alt="" width="200" height="400">
						</a>
					</td>
...
?>
					...
					<td class="cart-product-sub-total"><span class="cart-sub-total-price"><?php echo "TND"." ".$row['productPrice']; ?></span></td>
<td class="cart-product-sub-total"><span class="cart-sub-total-price"><?php echo "TND"." ".$row['shippingCharge']; ?></span></td>
					...
					<td class="cart-product-grand-total"><span class="cart-grand-total-price"><?php echo ($_SESSION['cart'][$row['id']]['quantity']*$row['productPrice']+$row['shippingCharge']); ?></span></td>
						...
						<input type ="submit"  value="Remove" class="btn btn-sm btn-danger" name="remove_code">
				</td>
</tr>
				<?php } }
$_SESSION['pid']=$pdtid;
			...
			<tr>
				<th>
					...
					<div class="cart-grand-total">
						Total<span class="inner-left-md"><?php echo $_SESSION['tp']="$totalprice"; ?></span>
					</div>
				</th>
			</tr>
		</thead><!-- /thead -->
